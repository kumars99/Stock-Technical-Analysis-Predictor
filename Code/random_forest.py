...
class RandomForest:
    ...
    def __init__(self, max_depth, num_trees, stump_class=RandomStumpInfoGain):
    ...
    def fit(self, X, y):
        ...
        # Fit each decision tree
        self.splitModel = splitModel
        self.subModel1 = RandomForest(self.max_depth-1, stump_class=self.stump_class)
        self.subModel1.fit(X[splitIndex1], y[splitIndex1])
        self.subModel0 = RandomForest(self.max_depth-1, stump_class=self.stump_class)
